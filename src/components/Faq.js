...
const Faq = () => {
    return (
      ...
      <Accordion.Item eventKey="0"className="shadow" >
        <Accordion.Header><h5>Explain CORS (Cross-Origin Resource Sharing) and Write its Importance.</h5></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="3" className="shadow" >
        <Accordion.Header><h5>Explain DOM (Document Object Model)?</h5></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="4" className="shadow">
        <Accordion.Header><h5>While building a web application, how do you consider SEO, maintainability, UX, performance, and security?</h5></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="5" className="shadow">
        <Accordion.Header><h5>What is an event loop in Node JS?</h5></Accordion.Header>
        <Accordion.Body>
        Asynchronous programming in JavaScript is made possible by the event loop. With JS, all operations occur on a single thread, but we can create the illusion of multi-threading by using smart data structures. Event loop takes care of anything that's async using a queue and listener. <br></br><br></br>

        So, when an async function has to be executed (or an I/O has to be performed), the main thread sends it to another thread, allowing v8 (Javascript engine) to continue running its code. The event loop consists of different phases with specific tasks like pending callbacks, close callbacks, timers, idle or prepare, poll, check, with different FIFO (First-In-First-Out) queues.<br></br><br></br>
      ...
      <Accordion.Item eventKey="6" className="shadow">
        <Accordion.Header><h5>What is the purpose of closures in JavaScript?</h5></Accordion.Header>
        <Accordion.Body>
