...
const Code = () => {
  return (
    <div className="content-section py-5 bg-Image text-white text-center" id="services">
            <div className="container my-5 px-4 px-lg-5">
                <div className="content-section-heading">
                    <h2 className='title-shadow text-dark'>What We Offer</h2>
                    <hr className="hr blurry-ruler mb-5  " />
                </div>
